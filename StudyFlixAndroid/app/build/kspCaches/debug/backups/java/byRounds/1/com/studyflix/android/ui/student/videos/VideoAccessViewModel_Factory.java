...
public final class VideoAccessViewModel_Factory implements Factory<VideoAccessViewModel> {
  ...
  public VideoAccessViewModel_Factory(
  ...
  @Override
  public VideoAccessViewModel get() {
  ...
  public static VideoAccessViewModel_Factory create(
      Provider<GetCurrentStudentUseCase> getCurrentStudentUseCaseProvider,
      Provider<CheckFeatureAccessUseCase> checkFeatureAccessUseCaseProvider,
      Provider<IncrementVideoUsageUseCase> incrementVideoUsageUseCaseProvider,
      Provider<IncrementPaperUsageUseCase> incrementPaperUsageUseCaseProvider,
      Provider<IncrementQuizUsageUseCase> incrementQuizUsageUseCaseProvider) {
    return new VideoAccessViewModel_Factory(getCurrentStudentUseCaseProvider, checkFeatureAccessUseCaseProvider, incrementVideoUsageUseCaseProvider, incrementPaperUsageUseCaseProvider, incrementQuizUsageUseCaseProvider);
  }

  public static VideoAccessViewModel newInstance(GetCurrentStudentUseCase getCurrentStudentUseCase,
    ...
    return new VideoAccessViewModel(getCurrentStudentUseCase, checkFeatureAccessUseCase, incrementVideoUsageUseCase, incrementPaperUsageUseCase, incrementQuizUsageUseCase);
  }
}
